...
import VSystemBar from 'vuetify/es5/components/VSystemBar'
...
//   VSelect,VSlider,VSnackbar,VStepper,VSubheader,
...
Vue.use(Vuetify, {
  ...
  VCard,
  VDatePicker,
  VDialog,VDivider,VFooter,VGrid,VIcon,
  VList,VMenu,VNavigationDrawer,VProgressCircular,
  VSelect,VSlider,VSnackbar,VStepper,VSubheader,
  VSwitch,VSystemBar,VTabs,VTextField,VToolbar,VTooltip,
  transitions
...
// Vue.use(VList)
// Vue.use(VMenu)
// Vue.use(VNavigationDrawer)
// Vue.use(VProgressCircular)
// Vue.use(VSelect)
// Vue.use(VSlider)
// Vue.use(VSnackbar)
// Vue.use(VStepper)
