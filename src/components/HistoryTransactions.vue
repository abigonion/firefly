                ...
                <div v-if="this.transactionsOperations[0].type=='payment'"><!--接收 Dispatcher-->
                  ...
                  <v-layout v-for="item in transactionsOperations" :key="item.id" class="transactionsOperationsItem">
                    <v-flex xs12>
                        ...
                        <v-layout>
                          <v-flex xs12 class="assetcodevaluestyle_payment">{{item.asset_type==='native'?"ORC":item.asset_type}}</v-flex>
                        </v-layout>
                        <v-layout>
                ...
                <div v-if="this.transactionsOperations[0].type=='manage_offer'"><!--Trade.Trade                                                                                                                                                                                                                                                                                                                                                                                                                                                     交易-->
                  ...
                  <v-layout v-for="item in transactionsOperations" :key="item.id" class="transactionsOperationsItem">
                      <v-flex xs12>
                          ...
                          <v-layout>
                              <v-flex xs12 class="manage_itemassetcode">{{item.selling_asset_type==='native'?"ORC":item.selling_asset_type}}→{{item.buying_asset_code}}</v-flex>
                          </v-layout>
                          <v-layout>
                  ...
                  <v-layout v-for="item in transactionsOperations" :key="item.id" class="transactionsOperationsItem">
                    <v-flex>
                      ...
                      <v-layout>
                        ...
                        <v-flex xs6 class="createaccountbalancemsg">ORC</v-flex>
                      </v-layout>
                    </v-flex>
                  </v-layout>
                </div>
