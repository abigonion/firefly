                ...
                <v-flex xs12 v-for="item in effectsData" :key="item.id+item.paging_token" >
                    <v-flex xs12 v-if="item.type=='account_credited'" class="content_style">
                        ...
                        <v-layout>
                            ...
                            <v-flex xs5 class="itemstyleth_account_credited">{{$t("AssetCode")}}：{{item.asset_type==="native"?"ORC":item.asset_code}}</v-flex>
                        </v-layout>
                        <v-layout>
                    ...
                    <v-flex v-if="item.type=='trade'" xs12 class="content_style">
                        ...
                        <v-layout xs12>
                                ...
                                <v-flex xs6 class="itemstyleth_trade" >-{{item.sold_amount}}{{item.sold_asset_type==="native"?"ORC":item.sold_asset_code}}</v-flex>
                        </v-layout>
                          <v-layout>
                        </v-layout>
                    </v-flex>
                    <v-flex v-if="item.type=='trustline_created'" xs12 class="content_style">
                        ...
                        <v-layout>
                            ...
                            <v-flex xs5 class="itemstyleth_trustline_c">{{$t("AssetCode")}}：{{item.asset_type==="native"?"ORC":item.asset_code}}</v-flex>
                        </v-layout>
                        <v-layout>
                    ...
                    <v-flex v-if="item.type=='trustline_removed'" xs12 class="content_style">
                        ...
                        <v-layout xs12>
                            ...
                            <v-flex xs5 class="itemstyleth_trustline_r">{{$t("AssetCode")}}：{{item.asset_type==="native"?"ORC":item.asset_code}}</v-flex>
                        </v-layout>
                        <v-layout>
                    ...
                    <v-flex v-if="item.type=='account_debited'" xs12 class="content_style">
                        ...
                        <v-layout>
                            ...
                            <v-flex xs5 class="itemstyleth_account_debited">{{$t("AssetCode")}}：{{item.asset_type==="native"?"ORC":item.asset_code}}</v-flex>
                        </v-layout>
                        <v-layout>
