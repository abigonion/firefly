  ...
  watch:{
   ...
   computed:{
    ...
    qrtext(){
      ...
      let data = {rainbow:{payment:{destination:this.account.address,amount: this.num}}}
      if(!isNativeAsset(this.selectedasset)){
        data.rainbow.payment.asset = {code:this.selectedasset.code, issuer: this.selectedasset.issuer}
      }
